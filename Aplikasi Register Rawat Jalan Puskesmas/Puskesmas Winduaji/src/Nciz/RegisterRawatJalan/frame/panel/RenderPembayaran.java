 ...
 * @author Ncizh
 */
public class RenderPembayaran extends JButton {

    private boolean over;
    private boolean press;
    public ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Nciz/RegisterRawatJalan/Gambar/pembayaran.png"));

    public RenderPembayaran() {

 ...
 * @author Ncizh
 */
public class RenderPeriksa extends JButton {

    private boolean over;
    private boolean press;
    public ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Nciz/RegisterRawatJalan/Gambar/periksa.png"));

    public RenderPeriksa() {

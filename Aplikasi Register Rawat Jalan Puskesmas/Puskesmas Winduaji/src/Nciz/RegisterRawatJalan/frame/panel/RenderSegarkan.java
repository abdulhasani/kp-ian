 ...
 * @author Ncizh
 */
public class RenderSegarkan extends JButton {

    private boolean over;
    private boolean press;
    public ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Nciz/RegisterRawatJalan/Gambar/segarkan.png"));

    public RenderSegarkan() {

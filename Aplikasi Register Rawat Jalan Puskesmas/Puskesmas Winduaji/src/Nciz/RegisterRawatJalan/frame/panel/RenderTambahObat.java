 ...
 * @author Ncizh
 */
public class RenderTambahObat extends JButton {

    private boolean over;
    private boolean press;
    public ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Nciz/RegisterRawatJalan/Gambar/AddObat.png"));

    public RenderTambahObat() {

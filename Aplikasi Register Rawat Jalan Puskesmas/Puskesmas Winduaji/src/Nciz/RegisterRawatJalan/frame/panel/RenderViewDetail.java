 ...
 * @author Ncizh
 */
public class RenderViewDetail extends JButton {

    private boolean over;
    private boolean press;
    public ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Nciz/RegisterRawatJalan/Gambar/detailPengobatan.png"));

    public RenderViewDetail() {
